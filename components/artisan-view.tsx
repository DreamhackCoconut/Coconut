...
export function ArtisanView({ data, loading, account, onRequireAccount, onCreated }: { data: SellerDashboard | null; loading: boolean; account: CoconutAccount | null; onRequireAccount: () => void; onCreated: (listing: SellerListing) => void }) {
